    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/doctor/analysis-result" element={<ProtectedRoute role="doctor"><AnalysisResult role="doctor" /></ProtectedRoute>} />
          <Route path="/doctor/customize" element={<ProtectedRoute role="doctor"><Customize role="doctor" /></ProtectedRoute>} />
          ...
          <Route path="/patient/analysis-result" element={<ProtectedRoute role="patient"><AnalysisResult role="patient" /></ProtectedRoute>} />
          <Route path="/patient/cases" element={<ProtectedRoute role="patient"><Cases /></ProtectedRoute>} />
          <Route path="/patient/customize" element={<ProtectedRoute role="patient"><Customize role="patient" /></ProtectedRoute>} />
